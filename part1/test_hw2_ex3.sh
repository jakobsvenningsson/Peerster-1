...
grep -q "PRIVATE: E:7:$message" C.log || fail "C didn't get message from E"
grep -q "PRIVATE: E:9:$message" B.log || fail "B didn't get message from E"
grep -q "PRIVATE: B:9:$message" E.log || fail "E didn't get message from B"
